...
var user_entity_js_1 = require("./models/user.entity.js"); // Importa el modelo de usuario
var updatePassword = function () { return __awaiter(void 0, void 0, void 0, function () {
    var email, newPassword, hashedPassword;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                email = "oskar.fdz111@gmail.com";
                newPassword = "spd69541";
                return [4 /*yield*/, bcrypt.hash(newPassword, 10)];
            case 1:
                hashedPassword = _a.sent();
                // Buscar al usuario y actualizar su contraseña
                return [4 /*yield*/, user_entity_js_1.User.findOneAndUpdate({ email: email }, // Encontrar al usuario por su email
